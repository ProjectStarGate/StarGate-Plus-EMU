...
enum BG_AB_Score {
	BG_AB_WARNING_NEAR_VICTORY_SCORE = 1400, BG_AB_MAX_TEAM_SCORE = 1600
};
...
enum BG_AB_Objectives {
	AB_OBJECTIVE_ASSAULT_BASE = 122, AB_OBJECTIVE_DEFEND_BASE = 123
};
...
// x, y, z, o
const float BG_AB_NodePositions[BG_AB_DYNAMIC_NODES_COUNT][4] = { { 1166.785f,
		1200.132f, -56.70859f, 0.9075713f }, // stables
...
const float BG_AB_DoorPositions[2][8] = { { 1284.597f, 1281.167f, -15.97792f,
		0.7068594f, 0.012957f, -0.060288f, 0.344959f, 0.93659f }, { 708.0903f,
		708.4479f, -17.8342f, -2.391099f, 0.050291f, 0.015127f, 0.929217f,
		-0.365784f } };
...
const uint32 BG_AB_GraveyardIds[BG_AB_ALL_NODES_COUNT] = { 895, 894, 893, 897,
		896, 898, 899 };

// x, y, z, o
const float BG_AB_BuffPositions[BG_AB_DYNAMIC_NODES_COUNT][4] = { { 1185.71f,
		1185.24f, -56.36f, 2.56f }, // stables
...
// x, y, z, o
const float BG_AB_SpiritGuidePos[BG_AB_ALL_NODES_COUNT][4] = { { 1200.03f,
		1171.09f, -56.47f, 5.15f }, // stables
