        ...
        switch (m_spellInfo->SpellFamilyName) {
            ...
            case SPELLFAMILY_WARRIOR: {
                ...
                if (m_spellInfo->SpellFamilyFlags[1] & 0x400) 
					damage = uint32(m_caster->GetTotalAttackPowerValue(BASE_ATTACK) * 0.65);
                // Victory Rush
                ...
                // Cleave
                else if (m_spellInfo->Id == 845) damage = uint32(
                        6
                                + m_caster->GetTotalAttackPowerValue(
                                        BASE_ATTACK) * 0.45);
                // Intercept
                else if (m_spellInfo->Id == 20253) damage = uint32(
                        1
                                + m_caster->GetTotalAttackPowerValue(
                                        BASE_ATTACK) * 0.12);
                    ...
                    if (power > 0) {
                        ...
                        damage += uint32(
                                (ap * 0.874 * 100 / 100 - 1) * mod / 100.0f);
                        m_caster->SetPower(POWER_RAGE,
                                (power - mod) + bonus_rage);
                    }
                ...
                damage = uint32(
                        ...
                        {
                    int32 pct = m_caster->CalculateSpellDamage(unitTarget,
                            m_spellInfo, 2);
                    if (pct > 0) damage += int32(
                            CalculatePctN(
                                    m_caster->GetTotalAttackPowerValue(
                                            BASE_ATTACK), pct));
                    break;
                    ...
                    uint32 trig_spell;
                    if (m_caster->HasAura(80979)) trig_spell = 87095;
                    else if (m_caster->HasAura(80980)) trig_spell = 87096;
                    else
                        break;

                    if (urand(0, 1)) m_caster->CastSpell(m_caster, trig_spell,
                            true);
                }
                break;
            }
            case SPELLFAMILY_WARLOCK: {
                ...
                else if (m_spellInfo->TargetAuraState
            ...
            case SPELLFAMILY_HUNTER: { // Rapid Recuperation
            ...
            switch (m_spellInfo->Id) {
                ...
                case 12868: {
                    ...
                    if (m_caster->haveOffhandWeapon()
                        ...
                        damage = (m_caster->GetFloatValue(UNIT_FIELD_MINDAMAGE)
                                + m_caster->GetFloatValue(UNIT_FIELD_MAXDAMAGE))
                                / 2;
                ...
                case 30507: // Poultryizer
                    ...
                    m_caster->CastSpell(unitTarget, 30501, true, m_CastItem);
                        ...
                        m_caster->CastSpell(unitTarget, 30504, true,
                                m_CastItem);
                    return;
        ...
        case SPELLFAMILY_GENERIC: {
            switch (m_spellInfo->Id) {
                        ...
                        case 300: {
                            if (canFly) {
                                if (unitTarget->ToPlayer()->Has310Flyer(false)) unitTarget->CastSpell(
                                    ...
                                    unitTarget->CastSpell(unitTarget, 75618,
                                            true);
                            } else
                                unitTarget->CastSpell(unitTarget, 75620, true);
                        }
                ...
                case 66545: //Summon Memory
                {
                    ...
                    uint32 uiSpells[26] = { 66704, 66705, 66706, 66707, 66709,
                            66710, 66711, 66712, 66713, 66714, 66715, 66708,
                            66708, 66691, 66692, 66694, 66695, 66696, 66697,
                            66698, 66699, 66700, 66701, 66702, 66703, 66543 };
                ...
                case 45668: // Ultra-Advanced Proto-Typical Shortening Blaster
                {
                    ...
                    static uint32 const spellPlayer[5] = { 45674, // Bigger!
                            45675, // Shrunk
                            45678, // Yellow
                            45682, // Ghost
                            45684 // Polymorph
                    ...
                    static uint32 const spellTarget[5] = { 45673, // Bigger!
                            45672, // Shrunk
                            45677, // Yellow
                            45681, // Ghost
                            45683 // Polymorph
                ...
                case 64142: // Upper Deck - Create Foam Sword
                    ...
                    static uint32 const itemId[] = { 45061, 45176, 45177, 45178,
                            45179, 0 };
        ...
        // Summon in random point all other units if location present
            ...
            switch (m_spellInfo->EffectImplicitTargetA[i]) {
                ...
                case TARGET_DEST_CASTER_RANDOM:
                    m_caster->GetNearPosition(pos, radius * (float) rand_norm(),
