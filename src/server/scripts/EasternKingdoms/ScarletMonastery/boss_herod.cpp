	...
	struct boss_herodAI: public ScriptedAI {
		...
		void JustDied(Unit* /*killer*/) {
			for (uint8 i = 0; i < 20; ++i)
				me->SummonCreature(ENTRY_SCARLET_TRAINEE, 1939.18f, -431.58f,
						17.09f, 6.22f, TEMPSUMMON_TIMED_OR_DEAD_DESPAWN,
						600000);
		}
...
public:
	mob_scarlet_trainee() :
			CreatureScript("mob_scarlet_trainee") {
	}
