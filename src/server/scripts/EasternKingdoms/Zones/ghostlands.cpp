...
public:
	npc_budd_nedreck() :
			CreatureScript("npc_budd_nedreck") {
	}
...
public:
	npc_rathis_tomber() :
			CreatureScript("npc_rathis_tomber") {
	}
...
public:
	...
	struct npc_ranger_lilathaAI: public npc_escortAI {
		npc_ranger_lilathaAI(Creature *c) :
				npc_escortAI(c) {
		}
		...
		void WaypointReached(uint32 i) {
			...
			case 18: {
				...
				Creature* Summ1 = me->SummonCreature(16342, 7627.083984f,
						-7532.538086f, 152.128616f, 1.082733f,
						TEMPSUMMON_DEAD_DESPAWN, 0);
				Creature* Summ2 = me->SummonCreature(16343, 7620.432129f,
						-7532.550293f, 152.454865f, 0.827478f,
						TEMPSUMMON_DEAD_DESPAWN, 0);
				if (Summ1 && Summ2) {
			...
			case 30:
				if (pPlayer && pPlayer->GetTypeId() == TYPEID_PLAYER)
					CAST_PLR(pPlayer)->GroupEventHappens(
							QUEST_ESCAPE_FROM_THE_CATACOMBS, me);
				break;
			case 32:
			...
			case 33:
				...
				Unit* CaptainHelios = me->FindNearestCreature(
						NPC_CAPTAIN_HELIOS, 50);
				if (CaptainHelios)
...
enum eCaptive {
	MOB1 = 16208, MOB2 = 16206, MOB3 = 16209
};
