...
enum Actions {
	ACTION_WATER_ELEMENT_HIT = 1, ACTION_WATER_ELEMENT_KILLED = 2,
};

// TODO get those positions from spawn of creature 29326
#define MAX_SPAWN_LOC 5
static Position SpawnLoc[MAX_SPAWN_LOC] = { { 1840.64f, 795.407f, 44.079f,
		1.676f }, { 1886.24f, 757.733f, 47.750f, 5.201f }, { 1877.91f, 845.915f,
		43.417f, 3.560f }, { 1918.97f, 850.645f, 47.225f, 4.136f }, { 1935.50f,
		796.224f, 52.492f, 4.224f }, };

class boss_ichoron: public CreatureScript {
public:
	boss_ichoron() :
			CreatureScript("boss_ichoron") {
	}
	...
	struct boss_ichoronAI: public BossAI {
		boss_ichoronAI(Creature* pCreature) :
				BossAI(pCreature, DATA_ICHORON) {
					...
					if (!bIsExploded) {
						if (!me->HasAura(SPELL_PROTECTIVE_BUBBLE, 0)) {
							...
							for (uint8 i = 0; i < 10; i++) {
								...
								me->SummonCreature(NPC_ICHOR_GLOBULE,
										SpawnLoc[tmp],
...
public:
	mob_ichor_globule() :
			CreatureScript("mob_ichor_globule") {
	}
	...
	struct mob_ichor_globuleAI: public ScriptedAI {
		mob_ichor_globuleAI(Creature* pCreature) :
