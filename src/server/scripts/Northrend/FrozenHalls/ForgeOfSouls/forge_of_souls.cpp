...
enum eSylvanas {
	GOSSIP_SPEECHINTRO = 13525, ACTION_INTRO,
};

enum Phase {
	PHASE_NORMAL, PHASE_INTRO,
};

class npc_sylvanas_fos: public CreatureScript {
public:
	npc_sylvanas_fos() :
			CreatureScript("npc_sylvanas_fos") {
	}

	struct npc_sylvanas_fosAI: public ScriptedAI {
		npc_sylvanas_fosAI(Creature* creature) :
				ScriptedAI(creature) {
...
public:
	mob_spiteful_apparition() :
			CreatureScript("mob_spiteful_apparition") {
	}

	struct mob_spiteful_apparitionAI: public ScriptedAI {
		mob_spiteful_apparitionAI(Creature* creature) :
				ScriptedAI(creature) {
		}
...
public:
	mob_spectral_warden() :
			CreatureScript("mob_spectral_warden") {
	}

	struct mob_spectral_wardenAI: public ScriptedAI {
		mob_spectral_wardenAI(Creature* creature) :
				ScriptedAI(creature) {
		}
...
public:
	mob_soulguard_watchman() :
			CreatureScript("mob_soulguard_watchman") {
	}

	struct mob_soulguard_watchmanAI: public ScriptedAI {
		mob_soulguard_watchmanAI(Creature* creature) :
				ScriptedAI(creature) {
		}
...
public:
	mob_soulguard_reaper() :
			CreatureScript("mob_soulguard_reaper") {
	}

	struct mob_soulguard_reaperAI: public ScriptedAI {
		mob_soulguard_reaperAI(Creature* creature) :
				ScriptedAI(creature) {
		}
...
public:
	mob_soulguard_bonecaster() :
			CreatureScript("mob_soulguard_bonecaster") {
	}

	struct mob_soulguard_bonecasterAI: public ScriptedAI {
		mob_soulguard_bonecasterAI(Creature* creature) :
				ScriptedAI(creature) {
		}
...
public:
	mob_soulguard_animator() :
			CreatureScript("mob_soulguard_animator") {
	}

	struct mob_soulguard_animatorAI: public ScriptedAI {
		mob_soulguard_animatorAI(Creature* creature) :
				ScriptedAI(creature) {
		}
...
public:
	mob_soulguard_adept() :
			CreatureScript("mob_soulguard_adept") {
	}

	struct mob_soulguard_adeptAI: public ScriptedAI {
		mob_soulguard_adeptAI(Creature* creature) :
				ScriptedAI(creature) {
		}
...
public:
	mob_soul_horror() :
			CreatureScript("mob_soul_horror") {
	}

	struct mob_soul_horrorAI: public ScriptedAI {
		mob_soul_horrorAI(Creature* creature) :
				ScriptedAI(creature) {
		}
