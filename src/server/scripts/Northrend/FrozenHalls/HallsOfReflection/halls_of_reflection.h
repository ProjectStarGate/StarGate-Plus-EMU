...
enum Data64 {
	DATA_FALRIC, DATA_MARWYN, DATA_LICHKING, DATA_FROSTMOURNE,
};
...
enum HorWorldStates {
	WORLD_STATE_HOR = 4884, WORLD_STATE_HOR_WAVE_COUNT = 4882,
};
...
struct boss_horAI: BossAI {
	boss_horAI(Creature *pCreature, uint32 id) :
			BossAI(pCreature, DATA_HOR) {
	}
