...
enum Spells {
	SPELL_PERMAFROST = 70326, SPELL_PERMAFROST_TRIGGER = 68786, // triggered by PERMAFROST. Used to check aura
...
public:
	...
	struct boss_garfrostAI: public BossAI {
		boss_garfrostAI(Creature *c) :
				BossAI(c, DATA_GARFROST_EVENT) {
