...
//Creatures
enum Creatures {
	CREATURE_SNAKE = 29680, CREATURE_CONSTRICTORS = 29713
};
...
static Position SpawnLoc[] = { { 1783.81f, 646.637f, 133.948f, 3.71755f }, {
		1775.03f, 606.586f, 134.165f, 1.43117f }, { 1717.39f, 630.041f,
		129.282f, 5.96903f }, { 1765.66f, 646.542f, 134.02f, 5.11381f }, {
...
public:
	...
	struct boss_slad_ranAI: public BossAI {
		boss_slad_ranAI(Creature *c) :
				BossAI(c, DATA_SLAD_RAN_EVENT) {
...
public:
	mob_slad_ran_constrictor() :
			CreatureScript("mob_slad_ran_constrictor") {
	}
	...
	struct mob_slad_ran_constrictorAI: public ScriptedAI {
		mob_slad_ran_constrictorAI(Creature *c) :
				ScriptedAI(c) {
		}
...
public:
	mob_slad_ran_viper() :
			CreatureScript("mob_slad_ran_viper") {
	}
	...
	struct mob_slad_ran_viperAI: public ScriptedAI {
		mob_slad_ran_viperAI(Creature *c) :
				ScriptedAI(c) {
		}
