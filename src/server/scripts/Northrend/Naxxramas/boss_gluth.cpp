...
const Position PosSummon[3] =
		{ { 3267.9f, -3172.1f, 297.42f, 0.94f },
				{ 3253.2f, -3132.3f, 297.42f, 0 }, { 3308.3f, -3185.8f, 297.42f,
						1.58f }, };
...
public:
	...
	class spell_gluth_decimate_SpellScript: public SpellScript {
		...
		void Register() {
			OnUnitTargetSelect +=
					SpellUnitTargetFn(spell_gluth_decimate_SpellScript::FilterTargets, EFFECT_0, TARGET_SRC_CASTER);
		}
	};
