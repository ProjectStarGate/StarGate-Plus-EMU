...
enum Horsemen {
	HORSEMEN_THANE, HORSEMEN_LADY, HORSEMEN_BARON, HORSEMEN_SIR,
};

enum Events {
	EVENT_NONE, EVENT_MARK, EVENT_CAST, EVENT_BERSERK,
};

const Position WaypointPositions[12] = {
// Thane waypoints
		{ 2542.3f, -2984.1f, 241.49f, 5.362f }, { 2547.6f, -2999.4f, 241.34f,
				5.049f }, { 2542.9f, -3015.0f, 241.35f, 4.654f },
		// Lady waypoints
		{ 2498.3f, -2961.8f, 241.28f, 3.267f }, { 2487.7f, -2959.2f, 241.28f,
				2.890f }, { 2469.4f, -2947.6f, 241.28f, 2.576f },
		// Baron waypoints
		{ 2553.8f, -2968.4f, 241.33f, 5.757f }, { 2564.3f, -2972.5f, 241.33f,
				5.890f }, { 2583.9f, -2971.67f, 241.35f, 0.008f },
		// Sir waypoints
		{ 2534.5f, -2921.7f, 241.53f, 1.363f }, { 2523.5f, -2902.8f, 241.28f,
				2.095f }, { 2517.8f, -2896.6f, 241.28f, 2.315f }, };
...
const int32 SAY_TAUNT[3][4] = { { -1533052, -1533045, -1533071, -1533059 }, {
		-1533053, -1533046, -1533072, -1533060 }, { -1533054, -1533047,
		-1533073, -1533061 }, };
	...
	struct boss_four_horsemenAI: public BossAI {
		...
		void SelectNearestTarget(Unit *who) {
			if (me->getVictim() && me->GetDistanceOrder(who, me->getVictim())
					&& me->canAttack(who)) {
				me->getThreatManager().modifyThreatPercent(me->getVictim(),
						-100);
		...
		void JustDied(Unit* /*killer*/) {
			...
			if (instance && DoEncounterAction(NULL, false, false, true)) {
				...
				instance->DoUpdateAchievementCriteria(
						ACHIEVEMENT_CRITERIA_TYPE_BE_SPELL_TARGET, 59450);
			}
		...
		void UpdateAI(const uint32 diff) {
			if (nextWP && movementStarted && !movementCompleted
					&& !nextMovementStarted) {
				nextMovementStarted = true;
				me->GetMotionMaster()->MovePoint(nextWP,
						WaypointPositions[nextWP]);
			}
			...
			if (!caster)
				DoMeleeAttackIfReady();
					...
					&& movementCompleted && !doDelayPunish)
				doDelayPunish = true;
		}
	};
};
