...
enum eData64 {
	DATA_ONYXIA_GUID, DATA_FLOOR_ERUPTION_GUID
};

enum eInstanceData {
	DATA_ONYXIA, MAX_ENCOUNTER,

	DATA_ONYXIA_PHASE, DATA_SHE_DEEP_BREATH_MORE, DATA_MANY_WHELPS_COUNT
};

enum eCreatures {
	NPC_WHELP = 11262, NPC_LAIRGUARD = 36561,
...
enum eGameObjects {
	GO_WHELP_SPAWNER = 176510, GO_WHELP_EGG = 176511
};
...
// Timed event for achievement 4402, 4005: More Dots! (10, 25 player) 5 min kill
};
#endif
