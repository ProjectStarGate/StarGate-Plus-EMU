...
const Position LorgusPosition[4] = { { -458.500610f, -38.343079f, -33.474445f,
		0.0f }, { -469.423615f, -88.400513f, -39.265102f, 0.0f }, {
		-622.354980f, -10.350100f, -22.777000f, 0.0f }, { -759.640564f,
		16.658913f, -29.159529f, 0.0f } };

const Position SpawnsLocation[] = { { -775.431f, -153.853f, -25.871f, 3.207f },
		{ -775.404f, -174.132f, -25.871f, 3.185f }, { -862.430f, -154.937f,
				-25.871f, 0.060f }, { -862.193f, -174.251f, -25.871f, 6.182f },
...
public:
	...
	struct instance_blackfathom_deeps_InstanceMapScript: public InstanceScript {
		instance_blackfathom_deeps_InstanceMapScript(Map* pMap) :
				InstanceScript(pMap) {
			Initialize();
		}
		;
			...
			case TYPE_AKU_MAI:
				...
				if (uiData == DONE)
					if (GameObject *pGo = instance->GetGameObject(m_uiAltarOfTheDeepsGUID)) {
						pGo->RemoveFlag(GAMEOBJECT_FLAGS, GO_FLAG_UNK1);
						pGo->SummonCreature(NPC_MORRIDUNE, SpawnsLocation[4],
			...
			case DATA_FIRE:
				...
				case 1:
					if (GameObject* pGO = instance->GetGameObject(m_uiShrine1GUID)) {
						pGO->SummonCreature(NPC_AKU_MAI_SNAPJAW,
								SpawnsLocation[0],
								TEMPSUMMON_CORPSE_TIMED_DESPAWN, 300000);
						pGO->SummonCreature(NPC_AKU_MAI_SNAPJAW,
								SpawnsLocation[1],
				...
				case 2:
					if (GameObject* pGO = instance->GetGameObject(m_uiShrine1GUID)) {
						for (uint8 i = 0; i < 2; ++i) {
							pGO->SummonCreature(NPC_MURKSHALLOW_SOFTSHELL,
									SpawnsLocation[0],
									TEMPSUMMON_CORPSE_TIMED_DESPAWN, 300000);
							pGO->SummonCreature(NPC_MURKSHALLOW_SOFTSHELL,
									SpawnsLocation[1],
				...
				case 3:
					if (GameObject* pGO = instance->GetGameObject(m_uiShrine1GUID)) {
						pGO->SummonCreature(NPC_AKU_MAI_SERVANT,
								SpawnsLocation[1],
								TEMPSUMMON_CORPSE_TIMED_DESPAWN, 300000);
						pGO->SummonCreature(NPC_AKU_MAI_SERVANT,
								SpawnsLocation[2],
				...
				case 4:
					if (GameObject* pGO = instance->GetGameObject(m_uiShrine1GUID)) {
						pGO->SummonCreature(NPC_BARBED_CRUSTACEAN,
								SpawnsLocation[0],
								TEMPSUMMON_CORPSE_TIMED_DESPAWN, 300000);
						pGO->SummonCreature(NPC_BARBED_CRUSTACEAN,
								SpawnsLocation[1],
