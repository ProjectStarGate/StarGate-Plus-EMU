...
// visitor helper
template<class VISITOR, class TYPE_CONTAINER> void VisitorHelper(VISITOR &v,
		TYPE_CONTAINER &c) {
	v.Visit(c);
}
;
...
template<class VISITOR> void VisitorHelper(VISITOR &v,
		ContainerList<TypeNull> &c) {
}

template<class VISITOR, class T> void VisitorHelper(VISITOR &v,
		ContainerList<T> &c) {
	v.Visit(c._element);
}

// recursion for container list
template<class VISITOR, class H, class T> void VisitorHelper(VISITOR &v,
...
template<class VISITOR, class OBJECT_TYPES> void VisitorHelper(VISITOR &v,
