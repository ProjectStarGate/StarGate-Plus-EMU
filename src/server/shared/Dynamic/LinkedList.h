...
public:
	...
	bool hasNext() const {
		return (iNext && iNext->iNext != NULL);
	}
	bool hasPrev() const {
		return (iPrev && iPrev->iPrev != NULL);
	}
	bool isInList() const {
...
public:
	...
	public:
		...
		Iterator() :
				_Ptr(0) { // construct with null node pointer
		}
		...
		bool operator==(Iterator const &_Right) const { // test for iterator equality
			return (_Ptr == _Right._Ptr);
		}

		bool operator!=(Iterator const &_Right) const { // test for iterator inequality
			return (!(*this == _Right));
		}

		bool operator==(pointer const &_Right) const { // test for pointer equality
			return (_Ptr != _Right);
		}
		...
		bool operator==(const_reference _Right) const { // test for reference equality
			return (_Ptr == &_Right);
		}
