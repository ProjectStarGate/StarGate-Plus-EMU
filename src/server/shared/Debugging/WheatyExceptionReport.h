...
const char* const rgBaseType[] = {
		...
		" unsigned __int64 ", " unsigned __int128 ", " <currency> ", // btCurrency = 25,
		" <date> ", // btDate = 26,
...
private:
	...
	static bool FormatSymbolValue(PSYMBOL_INFO, STACKFRAME *, char * pszBuffer,
			unsigned cbBuffer);

	static char * DumpTypeIndex(char *, DWORD64, DWORD, unsigned, DWORD_PTR,
			bool &, char*);

	static char * FormatOutputValue(char * pszCurrBuffer, BasicType basicType,
