...
#define STARGATE_LITTLEENDIAN 0
#define STARGATE_BIGENDIAN    1

#if !defined(STARGATE_ENDIAN)
#  if defined (ACE_BIG_ENDIAN)
#    define STARGATE_ENDIAN STARGATE_BIGENDIAN
#  else //ACE_BYTE_ORDER != ACE_BIG_ENDIAN
#    define STARGATE_ENDIAN STARGATE_LITTLEENDIAN
#  endif //ACE_BYTE_ORDER
#endif //STARGATE_ENDIAN
