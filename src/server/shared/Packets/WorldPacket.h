...
#ifndef ARKCORECORE_WORLDPACKET_H
#define ARKCORECORE_WORLDPACKET_H
...
public:
	...
	WorldPacket() :
			ByteBuffer(0), m_opcode(0) {
	}
	explicit WorldPacket(uint32 opcode, size_t res = 200, bool hack = false) :
